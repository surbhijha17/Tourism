...
def article_list(request,tag_slug=None):
    ...
    return render(request,'places/article_list.html',{'articles':articles,'tag':tag,'categories':categories})
...
def article_details(request,pk):
    ...
    if request.method == 'POST':
        ...
        comment_form =CommentForm()
    return render(request,'places/article_details.html',{'articles':post,'tag': tag, 'categories':categories,'post':post,'comments':comments,'similar_posts':similar_posts,'comment_form':comment_form,'reply':comment_qs,'is_liked':is_liked,'total_likes':post.total_likes(),})
...
def article_create(request):
    ...
    return render(request,'places/article_create.html',{'form':form})
...
def show_category(request,pk):
    ...
    return render(request,'places/category.html',{'posts':posts,'category':category,'categories':categories,})
